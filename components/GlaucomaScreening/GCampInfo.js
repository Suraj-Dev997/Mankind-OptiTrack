...
const GCampInfo = () => {
  ...
  const [nextCamp, setNextCamp] = useState();
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (Array.isArray(data) && data.length > 0) {
            ...
            setTextInputValue(doctorData.campCenter);
            ...
            console.log(doctorData.camp_location);
            setCampDate(doctorData.camp_date);
            setDoctor1(doctorData.doc_name1);
            setDoctor2(doctorData.doc_name2);
            setDoctor3(doctorData.doc_name3);
            setDoctor4(doctorData.doc_name4);
  ...
  useEffect(() => {
    ...
    fetch(ApiUrl, {
      ...
      .then(data => {
        ...
        if (data.length > 0) {
          // Use the brand_id from the first item in the response
          data.forEach(item => {
      ...
      <ScrollView>
        <View style={styles.form}>
          ...
          <TextInput
            ...
            style={styles.input}
          />
           <Text style={styles.datePickerLabel}>Next Camp plan date:</Text>
          <TextInput
            value={nextCamp}
            editable={false}
            mode="outlined"
