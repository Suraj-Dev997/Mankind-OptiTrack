...
const NIPosterList = () => {
  ...
  const handleEdit = (doctorId, dc_id) => {
    const {id} = route.params;
    navigation.navigate('NIUpdateUserProfileForm', {doctorId, dc_id, id}); // Pass the doctorId as a parameter
  };
        ...
        <View style={styles.headertop}>
          <LinearGradient colors={['#000953', '#092d4f']} style={styles.addbtn}>
            <Button
              ...
              onPress={() => navigation.navigate('NIUserProfileForm', {id})}>
              Add Poster
            </Button>
          </LinearGradient>
        </View>
